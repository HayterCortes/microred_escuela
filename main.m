...
[SoC, V_tank, P_grid_vec, Q_p_vec, Q_DNO_vec, V_aq_vec, h_p_vec] = sim_microrred(P_dem, P_gen, Q_dem, Ts, Tsim);

% Guardar resultados
save('results/resumen_variables.mat', ...
     'SoC', 'V_tank', 'P_grid_vec', 'Q_p_vec', 'Q_DNO_vec', 'V_aq_vec', 'h_p_vec');

% Graficar resultados de la simulación
plot_resultados(SoC, V_tank, P_grid_vec, Q_p_vec, Q_DNO_vec, V_aq_vec, h_p_vec, Ts);
